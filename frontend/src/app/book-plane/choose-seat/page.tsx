...
export default function ChooseSeatPage() {
    ...
    const [services, setServices] = useState<Service[]>([
        ...
        },
        {
            ...
            isSelected: false,
            icon: 'baggage',
            details: 'SGN → HAN Gói 20kg, HAN → SGN Gói 20kg'
        },
        {
            id: 'insurance',
    ...
    }, [departureFlight, returnFlight, totalAdults, totalChildren, totalInfants, servicesTotal]);
                                        ...
                                        {service.details && (
                                            <div className="mt-2 flex items-center space-x-4 text-sm text-black">
                                                <div className="flex items-center space-x-1">
                                                    <span>SGN ✈ HAN</span>
                                                    {service.id === 'seat-selection' && <div className="text-xs">27-D</div>}
                                                    {service.id === 'baggage' && <div className="text-xs">Gói 20kg</div>}
                                                </div>
                                                <div className="flex items-center space-x-1">
                                                    <span>HAN ✈ SGN</span>
                                                    {service.id === 'seat-selection' && <div className="text-xs">27-D</div>}
